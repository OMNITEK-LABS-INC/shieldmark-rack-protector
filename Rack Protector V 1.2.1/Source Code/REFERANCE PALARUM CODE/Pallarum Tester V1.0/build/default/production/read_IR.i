...
# 72 "read_IR.c"
    ...
    do{
        ...
        u16handSensorReadTxOff = adc_read_ir(0b00010000);



        u16handSensorReadTxOn = adc_read_ir(0b00010000);
    ...
    }while((i++ < 3) && (u16difference > (u16rollingAverage + 40)));
    ...
    else
    {
        ...
        if(u16difference > (u16rollingAverage + 40))
        {
...
uint16_t get_rolling_average(void)
{
    ...
    u16bufferAverage = u16bufferAverage >> 5;
