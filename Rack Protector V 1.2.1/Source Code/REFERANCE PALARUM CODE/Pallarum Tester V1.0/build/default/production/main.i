...
int main(int argc, char** argv)
{
    ...
    u16vppCheckCounter = 40;
    u8handSensorStartupDelay = 18;
    u16chargeTimeout = 200;
    ...
    if(eeprom_read_data(0x310040) == 0x55)
    ...
    while(1)
    {
        switch(dispenserState)
        {
            ...
            case IR_READS:
                ...
                if(PORTAbits.RA3 == 0){
                    smartlink_dispenser_event_load(0x56,0x44);
                    pSTRUCT_slXmtTransmitBuffer = &STRUCT_slXmtTransmitBuffer[0];
                ...
                if(PORTAbits.RA1 == 0){
                    smartlink_dispenser_event_load(0x52,0x45);
                    pSTRUCT_slXmtTransmitBuffer = &STRUCT_slXmtTransmitBuffer[0];
                    dispenserState = manage_buffer_transmit();
                ...
                if(start == 0)
                {
                    ...
                    if(start_count == 0){
                        smartlink_dispenser_event_load(0x53,0x42);
                ...
                if(PORTAbits.RA5 == 0){
                    SD = 2;
                    LATCbits.LATC2 = 0;
                    smartlink_dispenser_event_load(0x45,0x53);
                    pSTRUCT_slXmtTransmitBuffer = &STRUCT_slXmtTransmitBuffer[0];
                    dispenserState = manage_buffer_transmit();
                    dispenserState = PUMP_ENABLE;
                    break;
            ...
            case ACTIVATE_VALVE:
                ...
                LATCbits.LATC4 = 1;
                while(Pressurize_loops < 290)
                {

                spi_transceive_buffer_wait(0xC7);
                _delay((unsigned long)((85)*(4000000/4000.0)));
            ...
            case PUMP_ENABLE:
                ...
                if(SD == 0){
                    ...
                    smartlink_dispenser_event_load(0x65,0x73);
                    _delay((unsigned long)((1000)*(4000000/4000.0)));
                    pSTRUCT_slXmtTransmitBuffer = &STRUCT_slXmtTransmitBuffer[0];
                    dispenserState = manage_buffer_transmit();
...
# 501 "main.c"
                    ...
                    smartlink_dispenser_event_load(0x72,0x73);
                    _delay((unsigned long)((1000)*(4000000/4000.0)));
                    pSTRUCT_slXmtTransmitBuffer = &STRUCT_slXmtTransmitBuffer[0];
                    dispenserState = manage_buffer_transmit();
                    dispenserState = SLEEP_WAIT;
