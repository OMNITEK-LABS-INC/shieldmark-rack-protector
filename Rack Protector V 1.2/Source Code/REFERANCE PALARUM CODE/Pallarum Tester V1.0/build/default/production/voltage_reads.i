...
# 30 "voltage_reads.c" 2
# 1 "./constants.h" 1
# 31 "voltage_reads.c" 2
# 1 "./port_defines.h" 1
# 32 "voltage_reads.c" 2
# 1 "./voltage_reads.h" 1
# 30 "./voltage_reads.h"
...
void charge_enable(void)
{
    ...
    {
        if(adc_read_battery(0b00000001) < 450)
        {
...
void check_for_battery_switch(void)
{
    if(!STRUCT_statusFlags.b1auxActive)
    {
        if((u16eorBatteryVoltage < 450) || (STRUCT_statusFlags.b1loadedAAVoltageLow))
        {
            STRUCT_statusFlags.b1auxActive = 1;
