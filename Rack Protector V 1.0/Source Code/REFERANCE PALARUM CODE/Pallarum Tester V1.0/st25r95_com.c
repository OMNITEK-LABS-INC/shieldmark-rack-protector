...
ReturnCode st25r95SetFWT(uint8_t protocol, uint32_t fwt)
{
    ...
    if (protocol == ST25R95_PROTOCOL_ISO18092)
    {
        ...
        while (FWT > ((128UL + 1UL) * (128UL) * 32UL))
        {
            PP++;
            FWT /= 2UL;
        }
    ...
    {
        while (FWT > ((128UL + 1UL) * (255UL) * 32UL))
        {
            PP++;
            FWT /= 2;
        }
        do {
            if (FWT >  ((64UL + 1UL) * (255UL) * 32UL))
            {
                MM = 128UL;
                break;
            }
            if (FWT >  ((32UL + 1UL) * (255UL) * 32UL))
            {
                MM = 64UL;
                break;
            }
            if (FWT >  ((16UL + 1UL) * (255UL) * 32UL))
            {
                MM = 32UL;
                break;
            }
            if (FWT >  ((8UL + 1UL) * (255UL) * 32UL))
            {
                MM = 16UL;
                break;
            }
            if (FWT >  ((4UL + 1UL) * (255UL) * 32UL))
            {
                MM = 8UL;
                break;
            }
            if (FWT >  ((2UL + 1UL) * (255UL) * 32UL))
            {
                MM = 4UL;
                break;
            }
            if (FWT >  ((1UL + 1UL) * (255UL) * 32UL))
            {
                MM = 2UL;
                break;
            }
            if (FWT >  ((0UL + 1UL) * (255UL) * 32UL))
            {
                MM = 1UL;
                break;
            }
