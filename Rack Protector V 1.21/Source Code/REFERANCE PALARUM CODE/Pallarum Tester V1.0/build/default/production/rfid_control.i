...
# 1 "./rfal_analogConfig.h" 1
# 57 "./rfal_analogConfig.h"
# 1 "./platform.h" 1
# 65 "./platform.h"
# 1 "./typedefs.h" 1
# 66 "./platform.h" 2
...
# 72 "./platform.h" 2
# 58 "./rfal_analogConfig.h" 2
# 172 "./rfal_analogConfig.h"
...
typedef struct {
    rfalAnalogConfigRegAddr addr;
    rfalAnalogConfigRegMask mask;
    rfalAnalogConfigRegVal val;
...
enum {
    ...
    RFAL_TXRX_FLAGS_PAR_RX_REMV = (0U<<0),
...
enum
{
    RFAL_FELICA_POLL_RC_NO_REQUEST = 0x00,
    RFAL_FELICA_POLL_RC_SYSTEM_CODE = 0x01,
    RFAL_FELICA_POLL_RC_COM_PERFORMANCE = 0x02
};
...
typedef enum {
    ...
    RFAL_NFCA_T2T = 0x00,
    RFAL_NFCA_T4T = 0x20,
    RFAL_NFCA_NFCDEP = 0x40,
    RFAL_NFCA_T4T_NFCDEP = 0x60
...
typedef struct
{
    uint8_t anticollisionInfo;
    uint8_t platformInfo;
} rfalNfcaSensRes;
...
typedef struct
{
    rfalNfcaListenDeviceType type;
    rfalNfcaSensRes sensRes;
    rfalNfcaSelRes selRes;
    uint8_t nfcId1Len;
    uint8_t nfcId1[10U];

    rfalT1TRidRes ridRes;
...
# 331 "./rfal_nfca.h"
ReturnCode rfalNfcaPollerSingleCollisionResolution( uint8_t devLimit, _Bool *collPending, rfalNfcaSelRes *selRes, uint8_t *nfcId1, uint8_t *nfcId1Len );
# 367 "./rfal_nfca.h"
...
extern st25r95SPIRxContext st25r95SPIRxCtx;
# 271 "./st25r95_com.h"
...
# 564 "./st25r95_com.h"
extern _Bool st25r95PollField(void);
# 578 "./st25r95_com.h"
...
# 633 "./st25r95_com.h"
extern _Bool st25r95SPIIsTransmitCompleted(void);
# 646 "./st25r95_com.h"
extern _Bool st25r95UARTIsTransmitTxCompleted(void);
# 659 "./st25r95_com.h"
extern _Bool st25r95SPIIsInListen(void);
# 671 "./st25r95_com.h"
...
static uint8_t u8hibernate[] = {0x07, 0x0E, 0x08, 0x04, 0x00, 0x04, 0x00, 0x18, 0x00, 0x00, 0x60, 0x60, 0x64, 0x74, 0x3F, 0x10};
# 50 "rfid_control.c"
void ST25_init(void)
{
    uint8_t i, j;
    ...
    for(i = 3; i > 0; i--)
    {
        ...
        if( rfalInitialize() == ((ReturnCode)0U) )
        {
...
{
    LATBbits.LATB0 = 0;
    st25r95SPISendReceiveByte(0x00);
    st25r95SPIRxTx(u8hibernate, ((void*)0), u8hibernate[0x01U] + 2);
    LATBbits.LATB0 = 1;
}
# 107 "rfid_control.c"
void read_all_tag_data(void)
 ...
 if(err == ((ReturnCode)0U))
 {
  ...
  if ( (err == ((ReturnCode)0U)) && devCnt > 1)
  {
   ...
   devIt = 0;
            ...
            if(nfcaDevList[1].type == RFAL_NFCA_T2T)
            {
