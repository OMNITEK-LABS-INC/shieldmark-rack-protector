...
# 29 "interrupt_manager.c" 2
# 1 "./constants.h" 1
# 30 "interrupt_manager.c" 2
# 1 "./port_defines.h" 1
# 31 "interrupt_manager.c" 2
# 1 "./interrupt_manager.h" 1
# 35 "./interrupt_manager.h"
...
# 32 "interrupt_manager.c" 2
# 1 "./pic18f26q10.h" 1
# 33 "interrupt_manager.c" 2
# 48 "interrupt_manager.c"
...
# 109 "interrupt_manager.c"
    ...
    {
        for(lu8pollLoopCount = 4, lu8pollCountValid = 0; lu8pollLoopCount > 0; lu8pollLoopCount--)
        {

        }

        if(lu8pollCountValid >= 3)
        {
...

    {
        ...
        if(!BAUDCON1bits.WUE)
        {
            pSTRUCT_slRcvrBuffer -> u8rcvBufferByte[u8receiveBufferIndex] = u8readRcvBuffer;
                    ...
                    pSTRUCT_slRcvrBuffer -> u8rcvBufferValidFlag = 0xAA;

                    if(pSTRUCT_slRcvrBuffer < &STRUCT_slRcvrBuffer[3])
                    {
